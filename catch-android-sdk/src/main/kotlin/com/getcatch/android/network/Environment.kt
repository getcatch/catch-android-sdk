 ...
 * communicates with: production and sandbox.
 *
 ...
 * with the environments being used for Catch's Transaction APIs. For example, to open a given
 * checkout in live mode, the checkout must have been created using Catch's Live Transaction API
 * endpoint.
 *
