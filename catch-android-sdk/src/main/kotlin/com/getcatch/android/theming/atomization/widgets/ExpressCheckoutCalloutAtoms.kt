...
public data class ExpressCheckoutCalloutAtoms(
    ...
    internal data class Resolved(
        ...
        fun withOverrides(overrides: ExpressCheckoutCalloutAtoms?): Resolved {
        ...
        fun withOverrides(overrides: CatchAtoms) = Resolved(
            text = text.withOverrides(overrides.expressCheckout?.text ?: overrides.text),
            border = border.withOverrides(overrides.expressCheckout?.border ?: overrides.border),
            benefitText = benefitText.withOverrides(
                overrides.expressCheckout?.benefitText ?: overrides.benefitText
            ),
        )
    }
