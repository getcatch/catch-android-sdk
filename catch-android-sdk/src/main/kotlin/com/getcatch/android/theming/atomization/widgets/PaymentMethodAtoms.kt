...
public data class PaymentMethodAtoms(
    ...
    internal data class Resolved(
        ...
        fun withOverrides(overrides: PaymentMethodAtoms?): Resolved {
        ...
        fun withOverrides(overrides: CatchAtoms) = Resolved(
            text = text.withOverrides(overrides.paymentMethod?.text ?: overrides.text),
            border = border.withOverrides(overrides.paymentMethod?.border ?: overrides.border),
            benefitText = benefitText.withOverrides(
                overrides.paymentMethod?.benefitText ?: overrides.benefitText
            ),
        )
    }
