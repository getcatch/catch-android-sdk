...
public data class CampaignLinkAtoms(
    ...
    internal data class Resolved(
        ...
        fun withOverrides(overrides: CampaignLinkAtoms?): Resolved {
        ...
        fun withOverrides(overrides: CatchAtoms) = Resolved(
            text = text.withOverrides(overrides.campaignLink?.text ?: overrides.text),
            border = border.withOverrides(overrides.campaignLink?.border ?: overrides.border),
            benefitText = benefitText.withOverrides(
                overrides.campaignLink?.benefitText ?: overrides.benefitText
            ),
            actionButton = actionButton.withOverrides(
                overrides.campaignLink?.actionButton ?: overrides.actionButton
            ),
        )
    }
