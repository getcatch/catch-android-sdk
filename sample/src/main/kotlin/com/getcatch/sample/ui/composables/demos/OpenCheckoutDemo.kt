...
fun OpenCheckoutDemo(
    openDirectCheckout: (String, CheckoutPrefill) -> Unit
) {
    ...
    DemoSection(title = "Open Checkout", widgetContent = {
        Column(
            ...
            Button(
                ...
                Text("Open checkout", modifier = Modifier.padding(vertical = 8.dp))
            }
        }
    })
}
